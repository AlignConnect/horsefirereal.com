...
const Horsecontent = () => {
    return (
        ...
        <section className={noto.className}>
            ...
            <section className='bg-[url("/main/hftdelta_images/secondbg.webp")]  mx-auto py-5 bg-no-repeat bg-cover'>
                ...
                <img src="/main/hftdelta_images/productsecond.webp" alt="asd" loading='lazy' className='w-[80%] md:w-[60%] mx-auto py-[20px] relative -left-5' />
            ...
            <section>
                <div className='p-1'>
                    <div className='grid grid-cols-2'>
                        <div>
                            <div>
                                <img src="/main/hftdelta_images/pclose.webp" alt="asdasd" loading='lazy' className='mx-auto' />
                            </div>
                        ...
                        <div>
                            <div>
                                <img src="/main/hftdelta_images/ptick.webp" alt="asdasd" loading='lazy' className='mx-auto' />
                            </div>
