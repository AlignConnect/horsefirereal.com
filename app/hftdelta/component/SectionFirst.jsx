    ...
    return (
        <section className={noto.className}>
            ...
            <div className='grid grid-cols-2 itams-center px-2 py-5 min-h-[200px]'>
                <div><img src="/main/hftdelta_images/girl.webp" alt="sadasd" loading='lazy' className='w-[80%] mx-auto' /></div>
                <div><img src="/main/hftdelta_images/newline.webp" alt="sadasd" loading='lazy' className='w-full' /></div>
            </div>
