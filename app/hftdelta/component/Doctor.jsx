...
const Doctor = () => {
    return (
        <section className={noto.className}>
            ...
            <section className='bg-[url("/main/hftdelta_images/doctorback.webp")] text-center'>

                <h1 className='bg-[#fef102] font-bold text-3xl pt-4 px-4 my-4 pb-1 inline-block rounded-lg'>डॉक्टर द्वारा प्रस्तावित </h1>

                <div>
                    <img src="/main/hftdelta_images/doctor.webp" alt="sdasd" loading='lazy' width={200} height={200} className='w-[150px] h-[150px] border border-yellow-400 border-dashed p-2 rounded-[50%] mx-auto' />
                </div>
            ...
            <section className='text-center'>
                ...
                <div className='bg-[url("/main/hftdelta_images/backimg.webp")] bg-cover bg-contain  min-h-[400px]  pt-[30px]'>
                    ...
                    <div className='w-[95%] mx-auto'>
                        ...
                        <div className='grid grid-cols-2 gap-3 px-3 pt-7 text-center'>
                            ...
                            <div className=''>
                                ...
                                <div className=''>
                                    <img src="/main/hftdelta_images/im2.webp" alt="asdasd" loading='lazy' className='w-full rounded-lg' />
                                </div>
                            ...
                            <div>
                                ...
                                <div>
                                    <img src="/main/hftdelta_images/im1.webp" alt="asdasd" loading='lazy' className='w-full rounded-lg' />
                                </div>
                            ...
                            <div>
                                ...
                                <div>
                                    <img src="/main/hftdelta_images/im3.webp" alt="asdasd" loading='lazy' className='w-full rounded-lg' />
                                </div>
                            ...
                            <div>
                                ...
                                <div>
                                    <img src="/main/hftdelta_images/im4.webp" alt="asdasd" loading='lazy' className='w-full rounded-lg' />
                                </div>
            ...
            <section className=''>
                ...
                {/* <div className='grid grid-cols-2 p-3'>
                    ...
                    <div>
                        ...
                        <img src="/main/hftdelta_images/productfirst.png" alt="dsfs" loading='lazy' />
                ...
                <div className='relative min-h-[270px] md:min-h-[480px]'>
                    ...
                    <div className='absolute max-h-[270px] md:max-h-[480px] overflow-hidden -z-10 '>
                        ...
                        <img src="/main/hftdelta_images/productstand.webp" alt="asd" loading='lazy' className='w-full' />
                    ...
                    <div className='z-10 p-3 absolute max-h-[270px] md:max-h-[480px] transform md:translate-y-[50%]  max-h-[270px]  md:max-h-[480px] w-1/2 flex flex-col justify-center items-center'>
                        ...
                        <div className='text-2xl text-[#fef102] font-bold text-center'>
                            ...
                            <img src="/main/hftdelta_images/sevan.webp" alt="asdasd" loading='lazy' />
