...
const Header = () => {
    return (
        <section className={noto.className}>
            ...
            <section className='bg-[url("/main/hftdelta_images/firstbg.webp")] text-white bg-contain bg-cover'>

                <div className={`w-[95%] mx-auto py-3 ${poppin.className}`}>
                    <div className='text-white relative top-5 md:top-7 left-6 md:left-[15%] text-[14px] md:text-[16px]'>India's <span className='text-[#fff001]'>No.1</span> Male Wellness</div>
                    <h1 className='text-[3.4rem] md:text-[5rem] text-center text-white font-semibold'>HORSE FIRE</h1>
                    <h1 className='text-white tracking-[15px] text-2xl relative bottom-2 text-center relative -top-6'>TABLET</h1>
                </div>
                ...
                <div className='grid grid-cols-2 items-end min-h-[270px]'>
                    ...
                    <div>
                        <img src="/main/hftdelta_images/productfirst.png" alt="sdf" loading='eager' fetchPriority='high' className='w-full py-2' />
                    </div>

                    <div>
                        <img src="/main/hftdelta_images/newfirst.webp" alt="sdf" loading='eager' fetchPriority='high' className='w-full' />
                    </div>
