        ...
        <div className='w-full relative'>
            <div className='relative z-10 py-5 sm:py-10 px-5 sm:px-7 '>
                ...
                <div className="grid sm:grid-cols-12 items-end">
                    ...
                    <img src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/b27219bd-8801-4259-3273-ba4f8190d200/public' alt="pic" width='100%' height='100%' loading='lazy' className='mt-5 sm:mt-0' />
                    </div>
                </div>

            </div>
            <Image src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/4898f92b-2d03-4ef3-3915-b5edc1adc100/public' fill loading='lazy'  alt='pic' />
        </div>
