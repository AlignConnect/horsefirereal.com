...
function Section1() {
    ...
    const list2 = [
        {
            image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/760207d7-afa7-4235-9c85-fc214fa5d400/public',
            title: 'Side Effects'
        },
        {
            image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/480882e3-fc77-4d53-3645-8db950ff8600/public',
        ...
        <div className='w-full'>
            <div className="px-3 sm:px-5 py-5 sm:py-10 text-[1rem] sm:text-xl text-center fontPoppins">
                <div className="bg-black fontArya text-white rounded-lg  ">
                    ...
                    <p className="p-3 sm:p-5 pt-2">ये सभी कामोत्तेजक जड़ीबूटियां वैज्ञानिक रूप से प्रमाणित है और Horse Fire Tablet भी आयुष मंत्रालय भारत सकरार द्वारा प्रमाणित उत्पाद है। </p>
                </div>
                ...
                <img src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/ca8efbc8-8ed8-4d29-6689-881e239e7d00/public' alt="pic" width='100%' height='100%' loading="lazy" className='mt-5 sm:mt-8' />
