    ...
    return (
        <div className="">
            ...
            <div className='w-full relative bg-[#272526]'>
                <div className=" py-5 text-center px-3 sm:px-5 text-white">
                    ...
                    <div className="grid sm:grid-cols-2 ">
                        <img src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/a2162997-5ef5-4684-61c2-8fb94c489600/public' alt="pic" width='100%' height='100%' loading="lazy" className="hidden sm:block" />
                        <div className="sm:text-end text-2xl sm:text-3xl">
                            ...
                            <img src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/a2162997-5ef5-4684-61c2-8fb94c489600/public' alt="pic" width='100%' height='100%' loading="lazy" className=" sm:hidden mt-5" />
            ...
            <div className=' relative'>
                ...
                <Image src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/bb44b8fe-0763-4df1-118a-6de6d31a7b00/public' fill loading="lazy"  alt='pic' />
            </div>
        </div>
    )
}
