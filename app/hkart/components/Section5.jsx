    ...
    return (
        <div className='w-full py-2 md:py-5 px-3 '>
            ...
            <div className="max-w-4xl mx-auto  py-5 text-center md:pt-10 md:pb-5 relative ">
                ...
                <Image src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/bb27aca4-65ed-4d36-2da8-698c02f88100/public' fill alt="pic" className="absolute top-0 z-0 block md:hidden" />
            </div>
