...
const HeaderMain = () => {
    return (
        <div
            style={{
                backgroundImage: `url(https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/3c107bd8-4ff9-458d-bfc8-2abbd929e200/public)`,
            ...
            <div className="max-w-7xl mx-auto px-2 md:pt-10">
                <div className="flex md:flex-row flex-col md:items-center justify-center">
                    ...
                    <div className="flex flex-col justify-center items-center mt-6 md:mt-0">
                        <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/58aebd83-bac9-45d9-afe8-df9e084ce300/public" alt="pic" height={400} width={400} fetchPriority="high" />
