        ...
        <div className={`${noto.className} transform md:translate-x-[-50%] md:translate-y-[-50%] md:left-1/2 md:top-[45%] md:absolute md:w-[85%] translate-x-[0%] translate-y-[0%] left-0 top-0 relative w-full mx-auto my-0 md:px-4  px-0 order-2 md:order-3`}>
            <div className="grid grid-cols-1 md:grid-cols-3 items-center ">
                <div className={`bg-[#21cdc1] md:p-6 md:pt-12 p-2 pt-5`} >
                    <div className="flex items-center gap-4 md:gap-6">
                        <div className="min-h-[80px]">
                            <img src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/faeaa661-eedb-41f1-fe5d-dac16673e400/public' alt="pic" className="w-10/12 md:w-full mx-auto" loading='lazy' />
                        </div>
                ...
                <div className={`bg-[#3851a3]  md:p-6 md:pt-12 p-2 pt-5`} >
                    <div className="flex items-center gap-4 md:gap-6">
                        <div className="min-h-[80px]">
                            <img src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/e2a04e2c-55f5-45da-747f-456e1f436b00/public' alt="pic" className="w-10/12 md:w-full mx-auto" loading='lazy' />
                ...
                <div className={`bg-[rgb(18,23,68)]  md:p-6 md:pt-12 p-2 pt-5`} >
                    <div className="flex items-center gap-4 md:gap-6">
                        <div className="min-h-[80px]">
                            <img src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/c6365170-8a2f-4dba-4f2c-6620cb26d300/public' alt="pic" className="w-10/12 md:w-full mx-auto" loading='lazy' />
