...
const listproductBene = [
    { title: 'पति का छोटा, पतला और टेढ़ा लिंग', image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/685ef71c-8699-42de-f4a2-c72493dd4900/public' },
    { title: 'शीघ्रपतन, 1-5 मिनट की सेक्स अवधि', image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/370819f4-8323-4e23-ea3b-c50c0fa82300/public' },
    { title: 'कमजोर स्टैमिना, जल्दी थकावट', image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/96684819-b1f9-4de6-8b7e-cbf254fec200/public' },
    { title: 'जोश, उत्तेजना और सेक्स इच्छा की कमी', image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/1414dbf3-b058-4204-a406-72083e743e00/public' },
]
...
const HeaderSection = () => {
    return (
        <div
            style={{
                backgroundImage: `url(https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/218f1c80-783f-4faf-e7d8-270b33967b00/public)`,
                ...
                <div className="grid grid-cols-2 md:grid-cols-2 gap-2 md:gap-6">
                    <div className="order-1 md:order-1 relative">
                        ...
                        <div className="relative -ms-5 w-[140%]">
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/62490da7-07f5-4380-e054-36abb6215600/public" className='block md:hidden w-[100%] h-[120vw]' alt="pic" loading="lazy" />
