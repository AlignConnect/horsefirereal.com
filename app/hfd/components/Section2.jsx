...
const Section2 = () => {
    ...
    const listproductBene11 = [
        { title: 'लम्बा, मोटा फौलादी लिंग ', image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/344af302-8c6a-4a36-4e24-c05c7e0a8900/public' },
        { title: '45 मिनट से ज़्यादा सेक्स अवधि', image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/4727ca96-014e-4ea9-4607-f9ed288d7800/public' },
        { title: 'जोरदार इरेक्शन जो घंटो बना रहे', image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/0a0d210d-c290-4fad-ba31-4797d1026500/public' },
        { title: 'जोश, उत्तेजना और इच्छा में वृद्धि', image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/d1fb5e2c-9009-4087-2977-0405cbc78800/public' },
    ]
    ...
    return (
        ...
        <div className={`${noto.className} w-full`}>
            <div
                style={{
                    backgroundImage: `url(https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/e5356846-7f3a-4290-04e8-1ba671a74200/public)`,
                    ...
                    <div className="">
                        <div className="">
                            <div className="w-[100%] relative min-h-[200px]">
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/5cdf095a-1d39-46e6-5949-a0d05cff3900/public" alt="pic" className="w-full min-h-[200px] hidden md:block" loading="lazy" />
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/78a67f42-06ae-4821-bfb8-9b87ea016000/public" alt="pic" className="w-full min-h-[200px] block md:hidden" loading="lazy" />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 mt-[10%] gap-0 md:gap-4">
                            <div className="min-h-[450px]">
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/61e56fcb-11ac-40d5-86e5-714da1b8ff00/public" alt="pic" className="w-full min-h-[450px]" loading="lazy" />
                            </div>
            ...
            <div
                style={{
                    backgroundImage: `url(https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/1adf5766-87f9-4420-5994-65263a1db600/public)`,
                    backgroundSize: "cover",
                    backgroundRepeat: "no-repeat",
                    backgroundPosition: 'center'
                }}
            >
                <div className="max-w-7xl mx-auto px-2 md:pt-10">
                    ...
                    <div className="w-full py-6 md:py-12 min-h-[200px] md:min-h-[400px]">
                        <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/0d17125f-22ba-4dee-2e00-70d36c615000/public" alt="pic" className="w-full min-h-[200px] md:min-h-[400px]" loading="lazy" />
                    </div>
                </div>
            </div>
