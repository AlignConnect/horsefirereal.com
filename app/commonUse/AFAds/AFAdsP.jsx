...
const AFAdsP = () => {
    return (
        <div className='text-inherit bg-inherit flex items-center justify-center flex-col gap-5'>
            <div className="">
                <CommonImg imglink="/common_images/horsefirebox.webp" />
            </div>
            <p className="text-3xl -mb-2 font-semibold">We are Available:</p>
            <div className="flex w-full justify-center items-center gap-5">
                <a href="https://www.flipkart.com/r-ayurveda-horse-fire-tablets-ayurvedic-stamina-booster-men/p/itm937ddaf427ff8    " className=""><img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/1369a0a5-d191-4392-bf47-5c170ecb8600/public" alt="pic" className="w-40" width='100%' height='100%' /></a>
