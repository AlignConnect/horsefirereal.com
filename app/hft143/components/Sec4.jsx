    ...
    <div className='relative'>
      <div className="relative z-10 py-5 sm:py-10">
        <div className="text-center  text-3xl sm:text-5xl">
          ...
          <p className={`${poppin.className} inline bg-red-700 fontPoppins text-white px-5 sm:px-10 py-1`}> <span className="font-bold">HORSE FIRE </span> <span className="text-2xl sm:text-3xl">Tablet</span></p>
        </div>
