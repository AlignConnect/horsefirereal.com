...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefirereal.com/HFT143");
            formdata.append("ip", check ? check : "");
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked);
            formdata.append("blog_url", process.env.NEXT_APP_URL_HFT143 ?? "horsefirereal.com/hft143");
                        ...
                        <div className="py-5">
                            ...
                            <form className="space-y-3 px-2">
                                ...
                                <div className="flex justify-center items-center pt-6 ">
                                    <button onClick={handleFormSubmit} type="button" className="z-20 fontPoppins text-2xl font-bold px-3 pt-3 pb-1 md:w-72 w-full rounded-md bg-black text-white">
                                        SUBMIT
                                    </button>
                                </div>
                            </form>
