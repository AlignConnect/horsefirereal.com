...
import { CustomerDataValidator, CustomerDataValue } from "./FormDataValidation";
...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefirereal.com/hftnxteg");
            formdata.append("ip", check ? check : "");
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked);
            formdata.append("blog_url", process.env.NEXT_APP_URL_HFTNXTEG ?? "Horsefirereal.com/hftnxteg");
    ...
    return (<div className=" pb-5 bg-white" id="form">
        ...
        <h1 className="text-2xl md:text-4xl text-center anek text-[black] font-bold px-2 py-5 md:pt-10"><div className=" max-w-xl mx-auto">Fill out the form to get free consultation from expert doctors on call!</div></h1>
