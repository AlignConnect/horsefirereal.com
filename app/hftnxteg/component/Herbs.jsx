    ...
    return (
        <div className='bg-white fontNoto'>
            ...
            <div className="problems-container text-black">
                <h2 className="problems-heading font-bold anek">Key Herbs</h2>
            </div>
            <div className='px-3 flex items-center  gap-3'>
                ...
                <div className='fontPoppins'>
                    <h1 className='text-green-800 text-2xl sm:text-3xl font-bold fontPoppins fontNoto'>Ashwagandha</h1>
                    <p className=' text-lg'>Reduces stress, improves sexual stamina </p>
                </div>
            </div >
            ...
            <div className='px-3 flex items-center my-2 gap-3'>
                ...
                <div className='fontPoppins'>
                    <h1 className='text-green-800 text-2xl sm:text-3xl font-bold fontPoppins fontNoto'>Shilajit</h1>
                    <p className=' text-lg'>Boosts testosterone and strengthens erection</p>
                </div>
            </div>
            <div className='px-3 flex items-center my-2 gap-3'>
                <div className='min-w-[110px] max-h-[110px] ' >
                ...
                <div className='fontPoppins'>
                    <h1 className='text-green-800 text-2xl sm:text-3xl font-bold fontPoppins  '>Safed Musli</h1>
                    <p className=' text-lg'>Maintains energy and stamina during sex </p>
                </div>
            </div>
            <div className='px-3 flex items-center my-2 gap-3'>
                <div className='min-w-[110px] max-h-[110px] ' >
                ...
                <div className='fontPoppins'>
                    <h1 className='text-green-800 text-2xl sm:text-3xl font-bold '>Gokshura</h1>
                    <p className=' text-lg'>Strengthens penile tissues and hardness   </p>
                </div>
            </div>
            <p className='bg-gray-100 fontNoto pt-5 pb-3 text-xl text-red-700 text-center'>
                Other herbs also help treat all kinds of sexual weakness naturally and effectively.
            </p>
            ...
            <div className="problems-container text-black">
                <h2 className="problems-heading  font-bold anek">Key Benefits</h2>
            </div>


            <div className='p-2'>
                <div className='grid grid-cols-2 gap-4 items-center border border-pink-800 border-dashed py-2 px-4 my-2'>
                    <div><h1 className='text-[21px] sm:text-[26px] font-bold fontPoppins sm:px-5 text-[#e90f33]'>Control your <br />timing in bed</h1></div>
                ...
                <div className='grid grid-cols-2 gap-4 items-center border border-pink-800 border-dashed py-2 px-4 my-2'>
                    ...
                    <div><h1 className='text-[21px] sm:text-[26px] font-bold fontPoppins sm:px-5 text-[#e90f33]'>Get  harder 
                        <br />and longer erection</h1></div>
                </div>


                <div className='grid grid-cols-2 gap-4 items-center border border-pink-800 border-dashed py-2 px-4 my-2'>
                    <div><h1 className='text-[20px] sm:text-[25px] font-bold fontPoppins  sm:px-5 text-[#e90f33]'>Enjoy minimum <br />4 rounds every time</h1></div>
                ...
                <div className='grid grid-cols-2 gap-4 items-center border border-pink-800 border-dashed py-2 px-4 my-2'>
                    ...
                    <div><h1 className='text-[21px] sm:text-[26px] font-bold fontPoppins sm:px-5  text-[#e90f33]'>Feel intense passion <br />and stamina</h1></div>
                </div>
            </div>
            ...
            <div className='bg-[#e90f33] p-3 text-xl text-white'>
                ...
                Horse Fire Tablet is GMP, ISO, FDA, and AYUSH certified, and is one of the most trusted products for male weakness. With a 97.6% success rate, it delivers faster and better results than any other product.
            </div>
                ...
                <div className='grid grid-cols-2 w-full sm:w-[400px] mx-auto items-center justify-center gap-5 py-5 px-4'>
                    ...
                    <div className='bg-white w-[160px] rounded-2xl overflow-hidden pt-5'>
                        ...
                        <div className='pt-4 bg-[#fcc022] text-center'>
                            <p className='text-[16px] font-bold py-1'>Cash on Delivery available</p>
                        </div>
                    </div>
                    ...
                    <div className='bg-white w-[160px] rounded-2xl overflow-hidden pt-5'>
                        ...
                        <div className='pt-4 bg-[#fcc022] text-center'>
                            <p className='text-[16px] font-bold py-1 px-3'>97.6% Success Rate</p>
                        </div>
                    </div>
                    ...
                    <div className='bg-white w-[160px] rounded-2xl overflow-hidden pt-5 my-5'>
                        ...
                        <div className='pt-4 bg-[#fcc022] text-center'>
                            <p className='text-[15px] font-bold py-1'>Listed on Flipkart & Amazon</p>
                        </div>
                    </div>
                    ...
                    <div className='bg-white w-[160px] rounded-2xl overflow-hidden pt-5 my-5'>
                        ...
                        <div className='pt-4 bg-[#fcc022] text-center'>
                            <p className='text-[15px] font-bold py-1'>Trusted by  3 million men in India</p>
                        </div>
                    </div>
            ...
            <div className='my-4'>
                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/8c9db814-c857-4c3e-a903-4884fe732b00/public" alt="sdsdsd" loading='lazy' className='w-full' />
            </div>
        </div >
    )
}
