...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefirereal.com/HFT");
            formdata.append("ip", check ? check : "");
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked);
            formdata.append("blog_url", process.env.NEXT_APP_URL_HFT ?? "horsefirereal.com/HFT");
    ...
    return (
        <section className={`${noto.className} w-full md:w-[768px] mx-auto`}>
            ...
            <img src={"/main/hft_images/ico.png"} width={300} height={300} loading="lazy" className="mx-auto" />
