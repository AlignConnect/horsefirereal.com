                ...
                <div className="relative bg-white px-4">
                    <div className="grid grid-cols-12 items-center py-4 md:p-2" >
                        <div className="col-span-12 md:col-span-4 text-center mb-4 z-10">
                            ...
                            <img src="/main/hft_images/expert.jpg" alt="noimage" width={160} className="mx-auto" />
                        ...
                        <div className="col-span-12 md:col-span-8">
                            ...
                            <div className="mt-1 flex justify-end">
                                <img src="/main/hft_images/certi.png" alt="pic" className="max-h-[100px] min-h-[90px] max-w-[100px] min-w-[90px]" loading="lazy" />
                                <img src="/main/hft_images/certiSign.png" alt="pic" className="max-h-[100px] min-h-[90px] max-w-[100px] min-w-[90px]" loading="lazy" />
