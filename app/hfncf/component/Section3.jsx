                ...
                <section className="text-center bg-[#d4d0cd] mt-5 px-5">
                    ...
                    <div className="md:w-[75%] ms-auto">
                        <div className="flex items-center gap-2 my-5">
                            ...
                            <div>
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/e8cf307f-9a33-4401-8f37-58f0fb77c700/public" alt="ertyuiop" className="w-[30px]" />
                            </div>
                        ...
                        <div className="flex items-center gap-2 my-5">
                            ...
                            <div>
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/424bb3c4-8c36-40a1-f17e-482155192c00/public" alt="ertyuiop" className="w-[30px]" />
                            </div>
                        ...
                        <div className="flex items-unset md:items-center gap-2 mt-5">
                            ...
                            <div>
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/9800f412-1e74-49d8-d0f2-e008f8e6ae00/public" alt="ertyuiop" className="w-[35px] md:w-[30px]" />
                            </div>
