...
function Solution() {
    return (
        <section>
            <div className='bg-[#053C5E]'>
                <div className='w-full max-w-7xl mx-auto '>
                    <div className='grid md:grid-cols-12 gap-2 py-5 items-center'>
                        <div className='col-span-6 md:text-end text-center'>
                            <div className='fontPoppins font-extrabold text-4xl md:text-5xl px-2 py-2 text-white'>ये है समाधान</div>
                            <div className="fontNoto text-justify md:text-end text-[1.2rem] md:text-2xl px-2 py-1 text-white">
                        ...
                        <div className='col-span-6 '>
                            <img
                                ...
                                src={"https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/71b4edea-ce7e-42a0-60e7-e74720ff9600/public"}
            ...
            <div className="bg-[url('https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/a8532dd4-7943-43d5-ab0b-b56dc728ac00/public')] bg-cover" >
                <div className='w-full max-w-7xl mx-auto '>
                    <div className='grid md:grid-cols-12 gap-2 py-5 items-center'>
                        <div className='col-span-6 order-2 md:order-none'>
                            <img
                                className='w-96 mx-auto'
                                src={"https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/f0813b89-b720-43e5-f0b0-8ed2b52da400/public"}
                                alt='product_couple'
                                loading="lazy"
                            />
                        </div>
                        <div className='col-span-6 '>
                            <div className='fontPoppins font-extrabold text-3xl md:text-5xl px-2 py-2 '>भारत का <span className="text-4xl md:text-6xl text-[#bf190f]">No.1</span> सेक्सुअल प्रोडक्ट </div>
                            <div className="fontNoto text-[1.2rem] md:text-2xl px-2 py-1 ">
