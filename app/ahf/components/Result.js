                        ...
                        <div className='grid grid-cols-12 gap-2 py-6 items-center'>
                            <div className='col-span-5 '>
                                <img
                                    ...
                                    src={"https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/855a7d44-15da-4637-0989-2e43ae4d5f00/public"}
                                    alt='penis_img'
                                    loading='lazy'
                                />
                            </div>
                    ...
                    <div className="w-full max-w-7xl mx-auto py-3">
                        <div className="grid grid-cols-12 items-center  gap-2 py-3">
                            <img
                                ...
                                src={"https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/4119b719-d7a0-4ab3-c137-787a9539e000/public"}
                                alt='hf_product'
                                loading='lazy'
                            />
