...
const Section3 = () => {
    ...
    const listproductBene = [
        {
            title: 'अश्वगंधा',
            image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/6de6f350-3beb-416e-8f48-692953f98900/public',
            para: 'महानतम टेस्टोस्टेरोन और नाइट्रिक ऑक्साइड वर्धक'
        },
        {
            title: 'शिलाजीत',
            image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/1822b5c9-5a10-4dcf-da9b-932448bee300/public',
            para: 'नेचुरल वियाग्रा जो लिंग को कड़क और जोश बढ़ाए'
        },
        {
            title: 'केसर',
            image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/641ea289-1e4b-4f67-2271-e3f7d4b05700/public',
            para: 'श्रेष्ठ शक्ति एवं ऊर्जा वर्धक जो बेड पर लम्बा टिकाये'
        },
        {
            title: 'सफ़ेद मूसली',
            image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/6426cc8e-1bb0-469f-7fd6-deaa1ad4b600/public',
            para: 'शीघ्रपतन एंव ढीले लिंग की समस्या में कारगर'
        },
        {
            title: 'गोखरू',
            image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/214b184c-6c10-478f-f0cb-38c6955a8d00/public',
            para: 'लिंग मजबूती, व कामोत्तेजना बढ़ाने में अत्यंत असरदार'
        },
        {
            title: 'अभ्रक भस्म',
            image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/a63551db-726e-4d80-8f73-bae6de8c0c00/public',
    ...
    return (
        <div className=" w-full py-8 md:py-16 px-3 relative text-white">
               ...
               <FormRedirect/>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid sm:grid-cols-2 items-center gap-5 sm:gap-5">
                        <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/9d8bf300-cb55-42b4-3c96-9201c0bcef00/public" alt="pic" className="" width='100%' height='100%' />
                        <div className="">
            ...
            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/bd9a4c82-80fc-477c-4b3c-04838b48cd00/public" alt="img11" className="absolute top-0 left-0 h-full" width='100%' height='100%' />
        </div>
    )
}
