                ...
                <div className="max-w-4xl mx-auto">
                    <div className="grid grid-cols-12 gap-5 sm:gap-0 items-center">
                        <div className=" col-span-12 sm:col-span-4">
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/acc98a2e-20cb-406e-3fc4-6efcfa82b300/public" alt="pic" className="w-1/2 sm:w-full mx-auto" width='100%' height='100%' loading="lazy" />
                        </div>
                        <div className="col-span-12 sm:col-span-8 text-center">
                            ...
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/b067f126-7596-46f3-768c-4a0a3fec8d00/public" alt="pic" className="" width='100%' height='100%' loading="lazy" />
                        </div>
                    </div>
                </div>
            </div>
