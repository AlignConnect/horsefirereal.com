            ...
            <div className="bg-gray-200 py-5 px-3">
                <div className="max-w-6xl mx-auto ">
                    <div className="flex gap-2 sm:gap-5 items-center justify-center">
                        <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/9fd52b48-fea7-42b7-c6f9-9004fa2f1400/public" alt="pic" className="w-2/5 sm:w-[13rem]" width='100%' height='100%' loading="lazy" />
                        <div className="">
