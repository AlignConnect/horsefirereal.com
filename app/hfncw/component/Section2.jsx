    ...
    return (
        <section className={noto.className}>
            <section className="w-full md:w-[600px] mx-auto px-3">
                ...
                <div className="grid grid-cols-12 mx-auto items-center my-5 gap-5 text-[1.1rem] md:text-xl">
                ...
                <div className="bg-[#454549] px-3 text-xl text-white">
                    ...
                    <p>
                        हॉर्सफायर टैबलेट कोई चमत्कार नहीं बल्कि आधुनिक विज्ञान और आयुर्वेद का उत्तम संयोजन है जो प्राकृतिक तरीके से लिंग की <span className="text-red-600">तंग कोशिकाओं</span> को एक्टिव करता है। <span className="text-red-600">कॉर्पस केवरोसोम</span> (Corpus cavernosum)  को रक्त से भर देता है। डैमेज ब्लड वेसेल्स की मरम्मत कर कमजोर <span className="text-red-600">लिंग को फौलादी</span> आकार देता है।
                    </p>
                    <p className="mt-4">
                        हॉर्सफायर टैबलेट में मौजूद सभी जड़ीबूटियाँ और भस्म <span className="test-black">कामोत्तेजना बढ़ाने</span>, सेक्स पावर बढ़ाने के साथ-साथ <span className="text-red-600">स्ट्रेस रिलीवर</span> के तौर पर भी जानी जाती है। इसके नियमित सेवन से पुरुष कुछ ही दिनों में अपने <span className="text-red-600">जोश-स्टैमिना, सेक्स टाइमिंग और लिंग आकार</span> में अद्भुत बृद्धि महसूस करते है। इस प्रकार पुरुष के आत्मविश्वास में बृद्धि होती है, परफॉरमेंस की चिंता मिटाकर बेहतर सेक्स प्रदर्शन कर पाते है।
