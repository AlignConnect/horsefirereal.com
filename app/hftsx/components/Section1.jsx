                ...
                <div className=" text-2xl sm:text-3xl mt-5 space-y-3">
                    {list1.map((e, key) => {
                        return <div className="grid grid-cols-12 gap-1 sm:gap-4 " key={key}>
                            <div className=' col-span-2 sm:col-span-1'> <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/901272a2-0cf5-43fa-a32a-1eb6bd0b8400/public" alt="pic" width='100%' height='100%' loading='lazy' className='w-6/12 mx-auto sm:w-full' /></div>
