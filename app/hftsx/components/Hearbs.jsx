...
function Hearbs() {
    ...
    const list4 = [
        {
            title: 'अश्वगंधा',
            image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/0ef5a159-99f6-4261-1802-45ab294bb400/public',
            para: 'इसके इस्तेमाल से नाइट्रिक ऑक्साइड का निर्माण होता है, टेस्टोस्टेरोन, पौरुष क्षमता और इरेक्शन में वृद्धि होती है।'
        },
        {
            title: 'शिलाजीत',
            image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/0151b23f-2fa3-4438-b999-8d062df2cc00/public',
            para: 'नेचुरल वियाग्रा के नाम से मशहूर शिलाजीत पुरुषों में जोश, उत्तेजना, स्टैमिना और समय अवधि के विस्तार में मदद करता है।'
        },
        {
            title: 'सफेद मूसली',
            image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/d3a41810-57ce-4995-b508-fa0237305700/public',
            para: 'यह टेस्टोस्टेरोन बढ़ाता है, पार्ट के टिश्‍यूज को ताकत प्रदान करता है, इरेक्शन में सुधार करता है और टाइमिंग बढ़ाता है।'
        },
        {
            title: 'केसर',
            image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/9665c349-7b92-4a9a-3aeb-9c6f36e6da00/public',
            para: 'इसे आयुर्वेद में कामोत्तेजक और बलवर्धक माना गया है। या मूड और स्टैमिना बढ़ाता है जिससे अवधि बढ़ने में मदद करती है।'
        },
        {
            title: 'गोक्षुरा',
            image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/af721449-e364-4082-c7a1-5fc103416400/public',
        ...
        {
            title: 'शतावरी',
            image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/c6e72eb4-7b37-4104-7238-36ea5c96f600/public',
        ...
        <div className='w-full'>
            ...
            <div className='w-full relative bg-[#5a5a5a]'>
                <div className=" py-5  px-3 sm:px-10 text-white text-xl sm:text-2xl text-justify space-y-5">
                    ...
                    <img src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/cd86c257-b0d6-4e62-53ff-d26840aa1800/public' alt="pic" width='100%' height='100%' loading="lazy" className="my-3" />
