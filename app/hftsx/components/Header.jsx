    ...
    return (
        <div className='w-full text-white'>
            ...
            <div className="bg-[#160d0e] py-5 px-3 sm:px-16">
                ...
                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/b6531cc4-feb8-43e0-ad93-21a133393800/public" alt="pic" width='100%' height='100%' fetchPriority='high' className='my-5' />
