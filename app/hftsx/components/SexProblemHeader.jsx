...
function SexProblemHeader() {
    ...
    return (
        ...
        <div className="w-full text-xl sm:text-2xl py-5 sm:py-10 px-3 sm:px-12 ">
            ...
            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/f58272c0-861e-4139-3d80-2ff6be20ea00/public" alt="pic" width='100%' height='100%' loading='lazy' className='my-5 w-3/4 mx-auto' />
            <div className=" font-bold text-green-600 space-y-3 text-2xl sm:text-4xl">
                {
                    list.map((e, key) => {
                        return <div className="flex gap-4" key={key}>
                           <div  className='w-10 sm:w-12 ' ><img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/dd78ab21-634d-4db3-de2c-6799835bbd00/public" alt="pic" width='100%' height='100%' loading='lazy'/></div> 
