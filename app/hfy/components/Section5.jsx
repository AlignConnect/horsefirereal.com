            ...
            <div className="max-w-4xl mx-auto  py-5 text-center md:pt-10 md:pb-5 relative ">
                ...
                <div className="relative z-10 ">
                    <a href="#form" className=""><img
                        src={"https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/4b1323dd-249c-43ed-a054-77a2f4866a00/public"}
                        loading='lazy'
                        decoding="async"
                ...
                <Image src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/bb27aca4-65ed-4d36-2da8-698c02f88100/public' fill alt="pic" className="absolute top-0 z-0 block md:hidden" loading="lazy" />
            </div>
            ...
            <div className="w-full max-w-6xl mx-auto mt-5 md:mt-0">
                ...
                <div className="border-2 border-black py-2 px-2">
                    ...
                    <img
                        ...
                        src={"https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/56b17d72-3e52-4d4d-9830-408bf7896b00/public"}
                        alt='expert_aword'
                        loading="lazy"
                    />
                ...
                <img
                    ...
                    src={"https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/c8b3d22e-ad2e-4998-aee9-18ef0b1a0e00/public"}
                    alt='expert_aword'
                    loading="lazy"
                />
