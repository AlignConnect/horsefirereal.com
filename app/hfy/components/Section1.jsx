        ...
        <div className='w-full relative'>
            ...
            <div className="w-full md:w-[90%] relative z-10 grid md:grid-cols-2 mr-auto md:gap-4 items-center pb-6 md:pb-0">
                ...
                <div className="md:pt-10">
                    <img src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/4264e040-53d2-4517-c16d-d8766b73ed00/public' className='w-full h-full  hidden md:block min-h-[400px]' alt='pic' loading='lazy' />
                    <img src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/bdf8138b-3317-4c63-29ac-e6df3f509200/public' className='w-full h-full block md:hidden min-h-[400px]' alt='pic' loading='lazy' />
                </div>
                <div className="text-white  px-3 md:px-0 text-center md:text-left">
                    <img src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/fcdd367d-d82f-48bb-b35d-4a9e2b2e8b00/public' className='w-full h-full  hidden md:block min-h-[500px]' alt='pic' loading='lazy' />
            ...
            <Image src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/6bd0f7ae-ce13-4ca0-6291-941369f5c900/public' fill alt='pic' className='absolute top-0 z-0' loading='eager' fetchPriority='high' />
        </div>
    )
}
