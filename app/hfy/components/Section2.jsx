...
const Section2 = () => {
    ...
    const manNoEffect = [{
        ...
        image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/c18708f2-70a5-4351-afd1-c850f55b3400/public'
    },
    {
        title: 'शीघ्रपतन, 1-5 मिनट की सेक्स अवधि',
        image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/1a8339e2-54a8-475f-7beb-ae50cc35ab00/public'
    }, {
        title: 'कमजोर स्टैमिना, जल्दी थकावट',
        image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/4aef2717-9ecc-403b-c16f-87bbda500900/public'
    }, {
        title: 'जोश, उत्तेजना और सेक्स इच्छा की कमी',
        image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/3264a61b-c490-4409-cdd3-93fc420a0600/public'
    }]
                    ...
                    <div className="  fontPoppins">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 py-5 md:py-5 gap-x-4 gap-y-4 ">
                            {manNoEffect.map((e, key) => {
                                return <div key={key}>
                                    <img src={e.image} alt="pic" className="w-1/2 mx-auto min-h-[80px]" loading="lazy" />
