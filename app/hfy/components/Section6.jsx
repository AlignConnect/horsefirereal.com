...
const Section6 = () => {
    ...
    const cusReview = [{
        ...
        image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/09411d5a-88b6-4245-5d8c-1fd19802f000/public',
    ...
    },
    {
        ...
        image: 'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/d607cdf7-59b0-456b-a29d-fb4c5a3fc000/public',
    ...
    return (
        <div className='w-full'>
            <div className="relative fontPoppins text-white">
                ...
                <Image src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/b8ed6bcc-3a95-43e9-46f1-dc1a4c94dc00/public' fill className="w-full absolute top-0" loading="lazy" />
            </div>
