...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefirereal.com/CJHF");
            formdata.append("ip", check ? check : "");
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked);
            formdata.append("blog_url", process.env.NEXT_APP_URL_CJHF ?? "horsefirereal.com/cjhf");
    ...
    return (
        ...
        <section>
            ...
            <div className="mt-4 pb-5 bg-white" id="form">
                ...
                <AmaFlipDialog flipcartlink='https://flipkart.la/3HkWxXX' type="ts" />
