    ...
    const itemsToShow = useMemo(() => {
        return Reviews
            .slice(0, numberOfitemsShown).map((e, key) => {
                ...
                return <div key={key}>
                    <div className="mx-2 bg-white my-5 p-2 rounded-md" style={{ boxShadow: "-1px 0px 5px 0px  rgba(0, 0, 0, 0.16)" }} key={key}>
    ...
    return (
        <div>
            <div className='bg-gray-700 '>
                ...
                <section className='w-full bg-gray-300 py-3 md:py-7'>
