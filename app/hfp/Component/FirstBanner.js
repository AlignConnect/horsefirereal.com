            ...
            <div className='first_back min-h-[60px] w-full overflow-hidden'>
                ...
                <div className='grid grid-cols-12 m-auto w-[90%]'>
                    ...
                    <div className='col-span-6 md:col-span-5 grid grid-cols-12'>
                        ...
                        <div className='col-span-6 relative top-[-120px] md:top-[150px] left-[160px] md:left-[80px] w-[230px] md:w-[75%] mx-auto'>
                            <img src="/main/hfp_images/pro11.webp" alt="no" className='img-sec-prod min-h-[250px] w-full' loading='lazy' />
                        </div>
