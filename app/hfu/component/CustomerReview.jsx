                ...
                return <div key={key}>
                    <div className="mx-2 my-5 p-2 rounded-md" style={{ boxShadow: "-1px 0px 5px 0px black" }} key={key}>
                        <div className='flex justify-start align-items-center gap-2 mb-2 mt-2'>
                            ...
                            <div>
                                <h5 className='mb-0 text-center align-center text-xl font-bold'>{e.name}&nbsp;<img src="/common_images/verify.svg" className='w-[18px] h-[18px] inline' alt="pic" loading='lazy' /></h5>
                        ...
                        <div className="w-full md:w-[20rem] m-auto">
                            ...
                            } */}
                            {
                                ...
                                key === 1 &&
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/d5e3a89b-42a0-4717-20c8-49c5e1a5bb00/public" alt="no" className='max-w-[300px] md:max-w-[20rem] mx-auto' loading='lazy' />
                            }
                            {

                                key === 2 &&
                                <img src="/reviews/b_f.jpg" alt="no" className='max-w-[300px] md:max-w-[20rem] mx-auto' loading='lazy' />
                            }

                            {
                                key === 5 &&
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/d9150399-df58-428c-f3ac-43f624de2500/public" alt="no" className='max-w-[300px] md:max-w-[20rem] mx-auto' loading='lazy' />
                            }

                            {
                                key === 10 &&
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/cadcb4e9-4482-46f0-ad6d-76d5247d8b00/public" alt="no" className='max-w-[300px] md:max-w-[20rem] mx-auto' loading='lazy' />
                            }
