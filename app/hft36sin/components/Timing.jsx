...
function Timing() {
    ...
    const How_to_works = (arr) => {
        return arr?.map((e, key) => {
            return <div className=''><div className='grid grid-cols-12' key={key}>
                <img src={"https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/2a50ac66-10c2-4d0e-f27f-6d6a7dc58300/public"} className='col-span-1 w-10 mx-auto px-1' alt='right_tick' />
    ...
    return (
        <section>
            <div className="bg-[url('https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/b856571c-41e7-45ac-69b1-ab2d7fbd6600/public')] bg-cover" >
                ...
                <img
                    ...
                    src={"https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/0a2d06a8-7662-41ba-d5e0-63b2217b9700/public"}
                    alt='header_img'
                    fetchPriority='high'
                />
