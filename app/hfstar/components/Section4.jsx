        ...
        <div className="relative ">
            <div className="relative z-10 max-w-7xl mx-auto px-3 py-7 sm:py-14">
                ...
                <div className="grid sm:grid-cols-2 gap-5 sm:gap-10 items-center">
                    <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/593f7da6-c07d-4bfd-d3aa-afaba01adb00/public" alt="img11" className="" width='100%' height='100%' loading='lazy' />
