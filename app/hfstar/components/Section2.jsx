    ...
    const data = [
        {
            ...
            url: "https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/f3ed8960-7424-440b-70c7-5af9ca50df00/public",
        },
        {
            title: "COD पेमेंट सुविधा उपलब्ध",
            url: "https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/3e66cbcf-3af9-4db2-fa56-e020747d7c00/public",
        },
        {
            title: "10 दिनों की मनी बैक गारंटी सुविधा",
            url: "https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/00360e53-5a16-4acc-e388-43bc4b970a00/public",
        },
        {
            title: "ट्रस्टेड और प्रमाणित ब्रांड",
            url: "https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/19ccca09-32cd-4d90-6e93-9be472de4e00/public",
        },
        {
            title: "Amazon और Flipkart पर उपलब्ध",
            url: "https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/558e3ac1-ba2f-45d0-fb0c-eb75b358f400/public",
        },

        {
            title: "सिक्योर पैकेजिंग और फ़ास्ट डिलीवरी ",
            url: "https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/566321ae-6264-483a-7d63-597e7d748d00/public",
        },
    ];
        ...
        <div className="">
            ...
            <div className=" w-full py-5 md:py-10  relative">
                ...
                <div className=" relative z-10 -top-[3vw] left-0">
                    <img src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/f7efe08d-626e-40b6-e7f9-3fb983f35e00/public' width='100%' height='100%' className=" w-full sm:w-1/2" loading="lazy" />
                </div>
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-3">
                    ...
                    <div className="grid grid-cols-12 gap-[4vw] items-end -mt-[16vw] sm:-mt-[23vw] mb-5">
                        <div className="col-span-12 sm:col-span-5">
                            <img src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/6b96f229-04c0-4217-6447-c61567160e00/public' width='100%' height='100%' className="w-11/12 mx-auto sm:w-full" loading="lazy" />
                        </div>

                        <div className="col-span-12 sm:col-span-7">
                            <img src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/6465ec00-4af2-428c-ebee-20bf13698900/public' width='100%' height='100%' className="sm:ps-5" loading="lazy" />
                ...
                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/07567814-0e57-406f-aff7-53ea9d72cc00/public" alt="img11" className="absolute top-0 left-0 h-full" width='100%' height='100%' loading="lazy" />
            </div>
