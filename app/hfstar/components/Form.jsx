...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefirereal.com/HFSTAR")
            formdata.append("ip", check ? check : "")
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked)
            formdata.append("blog_url", process.env.NEXT_APP_URL_HFSTAR ?? "Horsefirereal.com/hfstar")
    ...
    return (<div className="relative" id="form">
        ...
        <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/499cca92-b1d3-4095-e0e3-be7904666100/public" alt="img11" className="absolute top-0 left-0 h-full" width='100%' height='100%' loading='lazy' />
