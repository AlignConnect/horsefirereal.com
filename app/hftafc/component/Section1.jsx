    ...
    return (
        <div>
            ...
            <div className='bg-[#fffee7] py-8 '>
                ...
                <div className='x-style w-[98%] sm:w-[70%] mx-auto flex flex-wrap sm:flex-nowrap items-center justify-center gap-10 bg-[#fff116]  p-5 sm:p-10 mt-5 rounded-xl  border-2 border-white px-2'>
                    <div>
