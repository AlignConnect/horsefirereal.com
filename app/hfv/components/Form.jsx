...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefirereal.com/HFV")
            formdata.append("ip", check ? check : "")
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked)
            formdata.append("blog_url", process.env.NEXT_APP_URL_HFV ?? "horsefirereal.com/hfv")
    ...
    return (<div className=" " id="form">
        ...
        >
            <div className="max-w-7xl mx-auto py-6 md:py-12 px-3">
                ...
                <h1 className="text-3xl md:text-[3.7rem] text-[#feffa6] text-center font-bold mb-2 md:mb-6">कॉल पर विशेषज्ञ डॉक्टरों से मुफ्त सलाह के लिए फॉर्म भरें !</h1>
