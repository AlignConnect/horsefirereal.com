                    ...
                    <div className="">
                        <div className="">
                            <div className="w-[100%] relative ">
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/5cdf095a-1d39-46e6-5949-a0d05cff3900/public" alt="pic" className="w-[100%] hidden md:block" />
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/78a67f42-06ae-4821-bfb8-9b87ea016000/public" alt="pic" className="w-[100%] block md:hidden" />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 mt-[10%] gap-0 md:gap-4">
                            <div className="">
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/61e56fcb-11ac-40d5-86e5-714da1b8ff00/public" alt="pic" className="w-full" />
                            </div>
            ...
            >
                <div className="max-w-7xl mx-auto px-2 md:pt-10">
                    ...
                    <div className="w-full py-6 md:py-12">
                        <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/0d17125f-22ba-4dee-2e00-70d36c615000/public" alt="pic" className="w-full" />
                    </div>
                </div>
            </div>
