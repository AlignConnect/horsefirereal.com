...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefirereal.com/HFA")
            formdata.append("ip", check ? check : "")
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked)
            formdata.append("blog_url", process.env.NEXT_APP_URL_HFA ?? "horsefirereal.com/hfa")
                ...
                <div className="py-4">
                    ...
                    <form className="space-y-3">
                        ...
                        <div className="flex justify-center items-center pt-4 ">
                            <button onClick={handleFormSubmit} type="button" className="bg-yellow-400 text-xl font-bold p-3 pt-3 md:w-72 w-full rounded-full text-black">
                                SUBMIT
                            </button>
                        </div>

                        {/* <img src="/main/hfa_images/security.png" alt="" className="mx-auto w-1/2 md:w-40" /> */}
