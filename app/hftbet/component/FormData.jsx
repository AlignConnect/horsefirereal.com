...
const Formdata = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefirereal.com/HFTBET")
            formdata.append("ip", check ? check : "")
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked)
            formdata.append("blog_url", process.env.NEXT_APP_URL_HFTBET ?? "horsefirereal.com/hftbet")
    ...
    return (<div className="" id="form">
        ...
        <div className="bg-black pb-5 w-full md:w-[650px] mx-auto">
            <div className="max-w-2xl mx-auto px-3" id='form'>
                        ...
                        <div>
                            ...
                            <form className="space-y-3">
                                ...
                                <div className="flex justify-center items-center pt-4">
                                    <button onClick={handleFormSubmit} type="button" className="bg-[#ff0000] text-white text-xl px-3 pt-3 pb-2 md:w-72 w-full rounded-xl hover:bg-black hover:text-white transition-colors font-bold">
                                        SUBMIT
                                    </button>
                                </div>
                ...
                {/* <AmaFlipDialog flipcartlink='https://flipkart.la/48bzV7j' type="ts" /> */}
